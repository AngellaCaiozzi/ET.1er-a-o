        ...
        if codigo in reposteria:
            if inventario[codigo][1] > 0:
                ...
                if codigo in carrito:
                    ...
                    tipo = reposteria[codigo][0]
                    sabor = reposteria[codigo][1]
                    precio = inventario[codigo][0]
                    carrito[codigo] = [tipo, sabor, precio, 1] 
                ...
                if seguir != 1:
                    ...
                    for i, (codigo, datos) in enumerate(carrito.items(), 1):
                        tipo, sabor, precio, cantidad = datos
                        totalParcial = precio * cantidad
                        print(f"{i}. {tipo} de sabor {sabor} - {cantidad} unidad(es) - Total: ${totalParcial}")
